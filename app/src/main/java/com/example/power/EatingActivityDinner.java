...
public class EatingActivityDinner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.achivmentIconButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(EatingActivityDinner.this,AchievmentActivity.class);
        ...
        findViewById(R.id.homeIconButton).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(EatingActivityDinner.this,MainActivity.class);
                startActivity(intent);
            }
        });
        findViewById(R.id.profileIconButton).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(EatingActivityDinner.this,ProfileActivity.class);
                startActivity(intent);
            }
        });
        findViewById(R.id.trainingIconButton).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(EatingActivityDinner.this,TrainingActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void showDialogNone() {
        final Dialog dialog = new Dialog(EatingActivityDinner.this);
